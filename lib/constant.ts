 ...
 */
export const APP_NAME = "check-o-chess";
...
export const APP_DESCRIPTION =
  "A miniapp to play chess and solve chess puzzles.";

/**
 * The primary category for the mini app.
 * Used for app store categorization and discovery.
 */
export const APP_PRIMARY_CATEGORY = "game";

/**
 * Tags associated with the mini app.
 * Used for search and discovery in app stores.
 */
export const APP_TAGS = ["check-o-chess", "chess", "puzzle", "game", "celo", "blockchain", "base"];
 ...
 */
export const APP_SPLASH_BACKGROUND_COLOR: string = "#09090b";
...
export const APP_ACCOUNT_ASSOCIATION: AccountAssociation | undefined = {
    "header": "eyJmaWQiOjEwODU2OTIsInR5cGUiOiJhdXRoIiwia2V5IjoiMHhkZDQ4MzJkM2NGODdFQzhjNTM0ZDg3QmVFMDMyMTIzNzU2MzM4NmJiIn0",
    "payload": "eyJkb21haW4iOiJjaGVjay1vLWNoZXNzLnZlcmNlbC5hcHAifQ",
    "signature": "dAiHfUXGcidDlkjEij0rOC3ZpfIsIkG5dbEooOwsYbIh7lr/Lm9LG4xCjLacbMzyQFXthl7wBgpjrSZdf8kcaRw="
